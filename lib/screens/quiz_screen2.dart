...
import 'package:dev_dashhhhhhhh/screens/result_screen2.dart';
...
class QuizScreen2 extends StatefulWidget {
  ...
  const QuizScreen2({super.key, required this.quizSet});
                  ...
                  children: [
                    ...
                    ElevatedButton(onPressed: (){
                      if (currentQuestionIndex < widget.quizSet.questions.length - 1) {
                        ...
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ResultScreen2(
                          totalQuestions:
